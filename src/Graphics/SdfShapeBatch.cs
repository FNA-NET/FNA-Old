...
{
	public class SdfShapeBatch
	{
		public SdfShapeBatch(GraphicsDevice graphicsDevice)
		{
			_graphicsDevice = graphicsDevice;
			_effect = new SdfShapeEffect(graphicsDevice);

			_vertices = new VertexSdfShape[MAX_VERTICES];
			_indices = GenerateIndexArray();

			_vertexBuffer = new DynamicVertexBuffer(_graphicsDevice, typeof(VertexSdfShape), _vertices.Length, BufferUsage.WriteOnly);
		...
		public void DrawCircle(Vector2 center, float radius, Color c1, Color c2, float thickness = 1f)
		{
			...
			_vertices[_vertexCount + 0] = new VertexSdfShape(new Vector3(topLeft, 0), new Vector2(-u, -u), 0f, c1, c2, thickness, ps);
			_vertices[_vertexCount + 1] = new VertexSdfShape(new Vector3(topRight, 0), new Vector2(u, -u), 0f, c1, c2, thickness, ps);
			_vertices[_vertexCount + 2] = new VertexSdfShape(new Vector3(bottomRight, 0), new Vector2(u, u), 0f, c1, c2, thickness, ps);
			_vertices[_vertexCount + 3] = new VertexSdfShape(new Vector3(bottomLeft, 0), new Vector2(-u, u), 0f, c1, c2, thickness, ps);
		...
		public void DrawRectangle(Vector2 xy, Vector2 size, Color c1, Color c2, float thickness = 1f)
		{
			...
			_vertices[_vertexCount + 0] = new VertexSdfShape(new Vector3(topLeft, 0), new Vector2(-ux, -uy), 1f, c1, c2, thickness, ps, ux);
			_vertices[_vertexCount + 1] = new VertexSdfShape(new Vector3(topRight, 0), new Vector2(ux, -uy), 1f, c1, c2, thickness, ps, ux);
			_vertices[_vertexCount + 2] = new VertexSdfShape(new Vector3(bottomRight, 0), new Vector2(ux, uy), 1f, c1, c2, thickness, ps, ux);
			_vertices[_vertexCount + 3] = new VertexSdfShape(new Vector3(bottomLeft, 0), new Vector2(-ux, uy), 1f, c1, c2, thickness, ps, ux);
		...
		public void DrawLine(Vector2 a, Vector2 b, float radius, Color c1, Color c2, float thickness = 1f)
		{
			...
			_vertices[_vertexCount + 0] = new VertexSdfShape(new Vector3(topLeft, 0), new Vector2(-ux, -uy), 2f, c1, c2, thickness, ps, ux - ur, ur);
			_vertices[_vertexCount + 1] = new VertexSdfShape(new Vector3(topRight, 0), new Vector2(ux, -uy), 2f, c1, c2, thickness, ps, ux - ur, ur);
			_vertices[_vertexCount + 2] = new VertexSdfShape(new Vector3(bottomRight, 0), new Vector2(ux, uy), 2f, c1, c2, thickness, ps, ux - ur, ur);
			_vertices[_vertexCount + 3] = new VertexSdfShape(new Vector3(bottomLeft, 0), new Vector2(-ux, uy), 2f, c1, c2, thickness, ps, ux - ur, ur);
		...
		private void Flush()
		{
			...
			_effect.ViewProjection = _view * _projection;
